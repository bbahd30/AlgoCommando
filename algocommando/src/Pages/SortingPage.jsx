...
const SortingPage = () => {
  ...
  const handleDeleteClick = (index) => {
    ...
    } else alert("Need to have atleast 4");
  };
  ...
  return (
    <>
      ...
      <Paper
        sx={{
          boxShadow:
            "0px 0px 15px rgba(0, 0, 0, 0.2), 0px 0px 10px rgba(0, 0, 0, 0.14)",
          ...
          <Box style={{ marginTop: "1rem" }}>
            ...
            <center>
              <Button
                ...
                variant="contained"
                onClick={() => dispatch(startAnimation())}
              >
                Visualize
              </Button>
            </center>
